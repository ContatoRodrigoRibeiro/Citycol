...
if ($side_widget_area === '1' && $side_widget_class !== 'simple' || true === $legacy_double_menu) {
	...
	<div id="slide-out-widget-area" class="<?php echo esc_attr($ocm_class); ?>"
		...
		data-back-txt="<?php echo esc_attr__('Voltar', 'salient'); ?>">
		...
		<div class="inner" data-prepend-menu-mobile="<?php echo esc_attr($prepend_mobile_menu); ?>">
			...
			if (
				$user_set_side_widget_area === 'off' && true !== $legacy_double_menu && $separate_mobile_ocm != '1' ||
			...
			if (
				has_nav_menu('off_canvas_nav') && $user_set_side_widget_area != 'off' ||
